...
class tokenElem:
    """ Token element node class. PrevId is -1 when the node is the
    first element in the token series. """
    def __init__( self, key, prevId=-1, nextId=-1, text="", identLevel=0, startOfLine=False, endOfLine=False ):
        self.key = key
        self.prevId = prevId
        self.nextId = nextId
        self.text = text
